...
This is a single-context VibeRack monorepo with Android, iOS, and smart chassis protocol docs.
...
4. Relevant Android Kotlin code under `app/src/main/java/com/viberack/app` and `domain/src/main/java/com/viberack/app/domain`.
5. Relevant iOS Swift code under `ios/VibeRack`.
6. `docs/adr/` if it exists later.
